...
from interface import Instructions, Interface, Button
...
class AsciiVideo:
    ...
    def __init__(self):
        ...
        self.ascii_set_toggle = Button(self, 'toggle font', self.win_width + 5,
            27)
    ...
    def run_game(self):
        while True:
            ...
            self.interface.draw_separation_lines()
            self.ascii_set_toggle.draw_button()
